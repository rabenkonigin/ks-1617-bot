"""No-Shows: alliance-wide registered-no-show ranking for Swordland Showdown / Tri-Alliance Clash."""
import asyncio
import sqlite3
...
_EVENT_LABEL_BY_KEY = {"foundry_battle": "Swordland Showdown", "canyon_clash": "Tri-Alliance Clash"}
